...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::table('infraction_types')->insert([
            ...
            [
                'code' => '518-21',
                'description' => 'Deixar de reduzir a velocidade do veículo de forma compatível com a segurança',
                'law_article' => 'Art. 220, I',
                'base_amount' => 195.23,
                'points' => 4,
                'severity' => 'medium',
                'active' => true,
            ...
            [
                'code' => '605-03',
                'description' => 'Avançar o sinal vermelho do semáforo - fiscalização eletrônica',
                'law_article' => 'Art. 208',
                'base_amount' => 293.47,
                'points' => 7,
                'severity' => 'very_severe',
            ...
            [
                'code' => '545-22',
                'description' => 'Estacionar sobre faixa destinada a pedestre',
            ...
            [
                'code' => '556-80',
                'description' => 'Dirigir sob influência de álcool',
                'law_article' => 'Art. 165',
                'base_amount' => 2934.70,
                'points' => 7,
                'severity' => 'very_severe',
            ...
            [
                'code' => '736-62',
                'description' => 'Dirigir veículo utilizando-se de fones nos ouvidos',
                'law_article' => 'Art. 252, VI',
                'base_amount' => 293.47,
                'points' => 5,
                'severity' => 'severe',
            ...
            [
                'code' => '545-26',
                'description' => 'Estacionar ao lado ou sobre canteiro central/divisor de pista',
                'law_article' => 'Art. 181, XXI',
                'base_amount' => 195.23,
                'points' => 4,
                'severity' => 'medium',
                'active' => true,
